## 2026-06-08 - Alphabetical sorting and command count in help menu
...
**Action:** Always sort dynamic lists of commands or features alphabetically and provide a summary count in the header to improve user orientation.
