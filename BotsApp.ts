                    ...
                    for(const msg of upsert.messages){
                        ...
                        if (BotsApp.isCmd) {
                            ...
                            if (!command) {
                                ...
                                const closest = inputSanitization.getClosestCommand(BotsApp.commandName, commandNames);
                                if (closest) {
                                    client.sendMessage(BotsApp.chatId, format(GENERAL.DID_YOU_MEAN, closest), MessageType.text);
                                } else {
